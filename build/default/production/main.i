...
void main(void)
{
    ...
    sendAck(0x00);
    LATCbits.LC2 = 1;
    _delay((unsigned long)((100)*(16000000/4/4000.0)));
    LATCbits.LC2 = 0;
    TRISCbits.TRISC4 = 1;
...
# 201 "main.c"
            switch (ReceiveMsg.frame.data0)
            {
                ...
                case 0x32:
                    LATCbits.LC2 = 1;
                    _delay((unsigned long)((3000)*(16000000/4/4000.0)));
                    LATCbits.LC2 = 0;
                    _delay((unsigned long)((1000)*(16000000/4/4000.0)));
                    sendAck(0x00);
                    break;
                case 0x33:
                    LATCbits.LC2 = 1;
...
# 290 "main.c"
    ...
    SPI1_ExchangeBlock(data_TX, sizeof(data_TX));
    PORTAbits.RA5 = 1;
    SPI1_Close();
# 397 "main.c"
    x = 0;
